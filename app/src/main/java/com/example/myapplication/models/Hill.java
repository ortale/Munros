...
public class Hill {
    ...
    public Integer getDoBIHNumber() {
        return doBIHNumber;
    }

    public void setDoBIHNumber(Integer doBIHNumber) {
    ...
    public Double getSubSection() {
        return subSection;
    }

    public void setSubSection(Double subSection) {
